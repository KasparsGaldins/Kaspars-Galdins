...
# 
nasa_api_key = "R97b91RsrPubJqgqiv997cniCJ7dA4ZAB8lWRiMc"
...
# If the status code is 200, parse the JSON data from the response text
	json_data = json.loads(r.text) 
# Initialize empty lists to store asteroid data
	ast_safe = [] #List for safe asteroids
	ast_hazardous = [] #List for hazard asteroids
...
# Extract miss distance information
 ...
 # If no close approach data is available, print a message and set default values
